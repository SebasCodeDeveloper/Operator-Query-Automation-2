...
/**
 * Gestor encargado de la persistencia de datos en archivos Excel. * Maneja la lectura de contactos y la actualización de estados de los operadores. * * @author SebasCodeDev * @version 1.3.1 * @since 01/24/2026
 */
public class ExcelManager {
    /**
     * Extrae la lista de números telefónicos desde la primera columna de la hoja principal. * @param rutaExcel Ruta absoluta o relativa del archivo .xlsx * @return Lista de strings con los números encontrados.
     */
    public static List<String> leerContactos(String rutaExcel) {
        List<String> contactos = new ArrayList<>();
        try (FileInputStream file = new FileInputStream(rutaExcel); Workbook workbook = new XSSFWorkbook(file)) {
    ...
    /**
     * Registra el resultado del operador en la columna correspondiente del archivo Excel. * @param rutaExcel Ruta del archivo. * @param fila Índice de la fila a modificar. * @param operador Texto con el nombre del operador detectado.
     */
    ...
    /**
     * Filtra las filas que no pudieron ser procesadas correctamente para su reintento. * @param rutaExcel Ruta del archivo. * @return Lista de índices de filas marcadas con error o no detectadas.
     */
