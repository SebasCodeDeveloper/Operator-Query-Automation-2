...
public class ConfigManager {
    ...
    /**
     * Recupera un valor específico basado en su identificador único (key). * * @param key Identificador de la propiedad definida en el archivo .properties. * @return El valor asociado como {@code String}, o {@code null} si la clave no existe.
     */
